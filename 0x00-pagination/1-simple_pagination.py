...
def index_range(*args, **kwargs) -> Tuple:
    ...
    Params:
    args(obj:tuple[int]): to pass args,which are ints
    kwargs(obj:dict[str, int]): a keyword arguments dictionary
...
class Server:
    """a Server class that paginates database of popular baby names.
    """
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """Fetches page content from dataset based on page_size
        """
